...
struct RoundedCornerShape: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        path.addArc(center: CGPoint(x: topLeft, y: topRight), radius: topLeft, startAngle: .degrees(180), endAngle: .degrees(270), clockwise: false)
        path.addArc(center: CGPoint(x: rect.maxX - topRight, y: topRight), radius: topRight, startAngle: .degrees(270), endAngle: .degrees(0), clockwise: false)
